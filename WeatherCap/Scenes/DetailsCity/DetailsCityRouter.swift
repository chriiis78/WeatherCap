...
class DetailsCityRouter: NSObject, DetailsCityRoutingLogic, DetailsCityDataPassing {
    ...
    //func navigateToSomewhere(source: DetailsCityViewController, destination: SomewhereViewController)
    //{
    ...
    //func passDataToSomewhere(source: DetailsCityDataStore, destination: inout SomewhereDataStore)
    //{
